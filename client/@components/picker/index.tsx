...
const NaflowsPicker: React.FC<NaflowsPickerProps> = ({
    parameters,
    options,
    onChange,
    value
                        ...
                        {options.map((option) => {
                            return (
                                <div key={option.id} onClick={() => {
                                    OnClick(onChange, value, option, _parameters.selectorID || selectorID, _parameters);
                                }}>
